...
mixin _$UserStore on _UserStore, Store {
  final _$loginViewModelAtom = Atom(name: '_UserStore.loginViewModel');
  ...
  final _$loadLoginFutureAtom = Atom(name: '_UserStore.loadLoginFuture');
  ...
  final _$userAsyncAction = AsyncAction('_UserStore.user');

  @override
  Future<LoginViewModel> user() {
